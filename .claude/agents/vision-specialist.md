...
|-------|------|-----------------|
| **planning-prd-agent** | Technical Project Manager | Creates PRDs; consult for vision feature requirements |
| **dependency-manager** | DevOps & Package Expert | **Delegate all vision library installations** (OpenCV, Tesseract, etc.) to them |
| **desktop-app-dev** | Desktop App Engineer | Implements features; coordinate on UI for visual features |
| **project-curator** | Project Structure Expert | Coordinate on asset/image folder organization |
| **workflow-optimizer** | Process Efficiency Expert | Optimize image processing pipelines |

**Handoff Protocol:**
- For vision library installations (OpenCV, pytesseract, etc.) → delegate to **dependency-manager**
- For visual feature UI implementation → coordinate with **desktop-app-dev**
- For organizing image assets/templates → work with **project-curator**
- When identifying vision requirements in PRD → inform **planning-prd-agent**
